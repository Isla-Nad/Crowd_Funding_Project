...
from projects.views import project_list, project_detail, createform, delete_project, add_report, report_comment_view,index,category_details
...
urlpatterns = [
    ...
    path('search/',index, name='project.search'),
